...
import numpy as np
name = 'MS_NR_AH09_E09'
command = 'python Submit_FP.py ' + name +  ' -E MS_NR_AH09_E09'
os.system(command)

name = lambda ARR,AGR : 'MS_RR_AH09_E09_ARR_AGR_%2.2f_%2.2f' % (ARR, AGR) 
command = lambda ARR,AGR: 'python Submit_FP.py ' + name(ARR,AGR) +  ' -E MS_RR_AH09_E09 --ARR '+ str(ARR) + ' --AGR ' + str(AGR)
